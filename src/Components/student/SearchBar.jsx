...
const SearchBar = (data) => {
  ...
  return (
        ...
        <form onSubmit={onSearchHandeler} className='max-w-xl w-full md:h-14 h-12 flex items-center
          ...
          type="text" placeholder="Search courses..." className='w-full h-full outline-none
          text-gray-500/80' />
