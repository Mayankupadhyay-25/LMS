      ...
      <div className='flex flex-col md:flex-row items-start px-8 md:px-0 
        ...
        <div className='hidden md:flex flex-col items-start w-full'>
          ...
          <div className='flex items-center gap-2 pt-4'>
            <input type="email" placeholder="Enter your email" className='border-gray-500/30 bg-gray-800
            text-gray-500 placeholder-gray-500 outline-none w-64 h-9 rounded px-2 text-sm'></input>
